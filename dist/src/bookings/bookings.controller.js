...
let BookingsController = class BookingsController {
    ...
    async createDaytrip(req, createBookingDaytripDto) {
        try {
    ...
    updateDaytrip(id, updateBookingDaytripDto) {
...
], BookingsController.prototype, "createDaytrip", null);
__decorate([
    (0, common_1.Get)('daytrip'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], BookingsController.prototype, "findAllDaytrip", null);
__decorate([
    (0, common_1.Get)('daytrip/:id'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], BookingsController.prototype, "findOneDaytrip", null);
__decorate([
    (0, common_1.Put)('daytrip/:id'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    ...
    __metadata("design:returntype", void 0)
], BookingsController.prototype, "updateDaytrip", null);
__decorate([
    (0, common_1.Delete)('daytrip/:id'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], BookingsController.prototype, "removeDaytrip", null);
__decorate([
    (0, common_1.Post)('update-existing-numbers'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], BookingsController.prototype, "updateExistingBookingNumbers", null);
__decorate([
    (0, common_1.Post)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    __param(0, (0, common_1.Request)()),
