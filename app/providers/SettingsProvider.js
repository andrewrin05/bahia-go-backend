...
const translations = {
  ...
  privacyChildrenBody: {
    ...
    en: 'Bahía Go is not directed to children under 18. If you believe a minor provided data, let us know so we can delete them.',
  },
  privacyContactBody: {
...
export const useSettings = () => {
  ...
  if (!ctx) {
    throw new Error('useSettings debe usarse dentro de AppSettingsProvider');
  }
  return ctx;
};
