...
INSERT INTO "new_Booking" ("boatId", "bookingNumber", "createdAt", "currency", "endDate", "id", "paymentCheckoutUrl", "paymentProvider", "paymentReference", "paymentStatus", "startDate", "status", "totalPrice", "updatedAt", "userId") SELECT "boatId", "bookingNumber", "createdAt", "currency", "endDate", "id", "paymentCheckoutUrl", "paymentProvider", "paymentReference", "paymentStatus", "startDate", "status", "totalPrice", "updatedAt", "userId" FROM "Booking";
DROP TABLE "Booking";
...
INSERT INTO "new_BookingDaytrip" ("bookingNumber", "createdAt", "currency", "daytripId", "id", "paymentCheckoutUrl", "paymentProvider", "paymentReference", "paymentStatus", "status", "totalPrice", "updatedAt", "userId") SELECT "bookingNumber", "createdAt", "currency", "daytripId", "id", "paymentCheckoutUrl", "paymentProvider", "paymentReference", "paymentStatus", "status", "totalPrice", "updatedAt", "userId" FROM "BookingDaytrip";
